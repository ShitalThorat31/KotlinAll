...
class Activity_POST:AppCompatActivity() {
    ...
    private lateinit var viewmodelGet: ViewModel_POST
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val getAPI=Utils_Post.getInstance().create(Api_POST::class.java)
        val repostory= Repository_POST(getAPI)
        ...
        viewmodelGet=ViewModelProvider(this,Factory_POST(repostory)).get(ViewModel_POST::class.java)
        ...
        viewmodelGet.getData.observe(this, Observer {
            ...
            Log.d("POST_METHOD",it.title.toString())
