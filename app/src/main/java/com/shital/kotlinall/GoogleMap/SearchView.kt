package com.shital.kotlinall.GoogleMap
...
class SearchView: AppCompatActivity(), OnMapReadyCallback, LocationListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_maps_searchview)
